...
def _run_review_pass(diff: str, pr_title: str, pass_info: dict) -> str:
    """Run one focused review pass via GitHub Models API and return the text response."""
    prompt = (
...
def review_pr(repo: str, pr_number: int) -> str:
    """
    Fetch diff, run 3 review passes (quality/security/deps) via GitHub Models,
    ...
    review = (
        ...
        + "\n\n---\n\n".join(sections)
        + "\n\n---\n*Review generated by SQA Agent · gpt-4o (GitHub Models)*"
    )
